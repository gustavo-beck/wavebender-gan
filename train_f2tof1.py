...
from data_utils import F1AndF2Loader, F2AndF1Collate
...
def prepare_data(params):
    ...
    collate_fn = F2AndF1Collate(params.n_frames_per_step, features_selected)
...
def train(params):
    ...
    for epoch in tqdm(range(params.total_training_epochs)):
        ...
        if test_loss[-1] < best_sig:
            ...
            best_epoch = epoch + 1
            save_wavebendernet(model, "f2tof1.pt")
    ...
    plt.savefig("F2_to_F1_Learning_Curves.png")
    plt.close()
